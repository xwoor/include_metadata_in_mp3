...
class getid3_writetags
{
	 ...
	 * @var array
	 */
	public $tagformats         = array('id3v1', 'id3v2.2', 'id2v2.3', 'id3v2.4');
	...
	public function FormatDataForID3v1() {
		...
		$tag_data_id3v1['albumartist'] =        getid3_lib::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['ALBUMARTIST']    ) ? $this->tag_data['ALBUMARTIST']     : array())));
	...
	public function FormatDataForReal() {
		...
		$tag_data_real['albumartist']   = getid3_lib::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['ALBUMARTIST']  ) ? $this->tag_data['ALBUMARTIST']   : array())));
